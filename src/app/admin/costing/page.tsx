...
function CostingPageContent() {
  ...
  const activeFilterCount = useMemo(() => {
    ...
    return count;
  }, [sizeFilter, minProfitFilter, maxProfitFilter, minCostFilter, maxCostFilter, minSellingPriceFilter, maxSellingPriceFilter]);
        ...
        <div className="px-5 py-3.5 border-b border-slate-100 flex flex-wrap items-center gap-3">
          <div className="relative flex-1 min-w-[180px] max-w-xs">
            ...
            <input
              ...
              placeholder="Search design no or description..."
            />
          </div>
